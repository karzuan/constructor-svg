...
import xb from './images/x-bordered.svg';
        ...
        return (
            <React.Fragment>
                ...
                <div className='row'>
                    ...
                    { isTrue && <Component /> }
                    */}
                        {this.state.activedge && <div className="form-inline box"><CirclePicker
                            color={this.props.edge}
                            onChangeComplete={this.props.handleEdgeColorChange}
                        /><span className="close" onClick={() => this.handleClick('edge')} > <img src={xb} alt="close" /> </span></div>}
                            <li><p className="objectPart" onClick={() => this.handleClick('fill')}>Fill</p></li>
                            {this.state.activfill && <div className="form-inline box"><CirclePicker
